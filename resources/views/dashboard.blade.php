        ...
        <div class="flex gap-5 max-md:flex-col max-md:gap-0">
            <div class="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                <div class="flex flex-col grow p-7 w-full text-black bg-white rounded-3xl max-md:px-5 max-md:mt-10">
                    <img loading="lazy" srcset="..." class="w-full aspect-[1.05]" />
            ...
            <div class="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                <div
                    ...
                    <img loading="lazy" srcset="..." class="w-full aspect-[1.04]" />
                ...
                <div class="grow max-md:mt-10 max-md:max-w-full">
                    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
                        <div class="flex flex-col w-[34%] max-md:ml-0 max-md:w-full">
                            <img loading="lazy" srcset="..." class="grow w-full aspect-[0.86]" />
                        </div>
                ...
                <div class="grow px-5 mt-14 max-md:mt-10 max-md:max-w-full">
                    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
                        ...
                        <div class="flex flex-col ml-5 w-[43%] max-md:ml-0 max-md:w-full">
                            <img loading="lazy" srcset="..." class="grow w-full aspect-[0.98] max-md:mt-10" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="self-center px-5 mt-14 w-full max-w-[1250px] max-md:mt-10 max-md:max-w-full">
        <div class="flex gap-5 max-md:flex-col max-md:gap-0">
            <div class="flex flex-col w-[37%] max-md:ml-0 max-md:w-full">
                <img loading="lazy" srcset="..." class="grow w-full aspect-[0.99] max-md:mt-10 max-md:max-w-full" />
            </div>
...
<div class="flex flex-col justify-end pt-16 w-full bg-stone-50 max-md:max-w-full">
            ...
            <div class="flex flex-col ml-5 w-[44%] max-md:ml-0 max-md:w-full">
                <div
                    ...
                    <div class="flex gap-5">
                        <img loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/5faa00b15529ff7f47a0ff71af668698792e4e091ea851fb69f5b3a21680fecc?"
                            class="shrink-0 w-6 aspect-square" />
                        <div class="flex-auto my-auto">monocafeservices@gmail.com</div>
                    </div>
                    <div class="flex gap-5 mt-6">
                        <img loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/3e4c1f0ccb3b9a5d13a18a37cfba335a970ddd6c019a76d8655f5e83f6dcfe14?"
                            class="shrink-0 w-6 aspect-square" />
                        <div class="flex-auto">@monocafe</div>
                    </div>
                    <div class="flex gap-5 mt-6">
                        <img loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/5d21cfeb8361e737fd848b36e99cea6a39a478f9d26c40039d511ff92b2fe1f1?"
                            class="shrink-0 w-6 aspect-square" />
